...
Hash step arguments (DocString, DataTable) into a scenario's diff signature.
...
Only argument *content* is hashed. Locations are excluded (moving a scenario down the file is not a
